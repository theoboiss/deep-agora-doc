...
\img{TextLine/metrics/trainloss.png}{Loss curve of TextRegion model on training set}{width=0.7\textwidth}
\img{TextLine/metrics/valloss.png}{Loss curve of TextRegion model on validation set}{width=0.7\textwidth}
