...
\begin{itemize}
\item Mettre en oeuvre des techniques de Deep Learning et Computer Vision.
\item Mener des expérimentations exploitant et évaluant des techniques d'Intelligence Artificielle.
\item Refonte du projet PaRADIIT du LIFAT sponsorisé par Google
\end{itemize}
}{pic/google.jpg}{}

\posterblock{Mise en œuvre}{
\begin{enumerate}
\item Développement d'un outil de création de données d'apprentissage.
\item Développement d'un outil d'entraînement et d'utilisation de réseaux de neurones profonds.
\item Entraînement et évaluation de modèles de réseaux de neurones.
\end{enumerate}
}{pic/cesr.jpg}{}

\posterblock{Résultats attendus}{
\begin{itemize}
\item Segmentation sémantique d'images de documents anciens.
\item Modèles de réseau de neurones profond capable de segmenter des éléments de contenu.
\item Base logiciel robuste pour la refonte d'un logiciel sur le long terme.
\end{itemize}
}{pic/example.png}{}
...
\img{wordmask.png}{Mask of Volum_069_Registres_0004 from "IEHHR-XMLpages" dataset}{width=0.5\textwidth}
\img{wordimage.jpg}{Image of Volum_069_Registres_0004 from "IEHHR-XMLpages" dataset}{width=0.5\textwidth}
